...
const GOALS = [
  { k: "", l: "Nói tự tin (nền tảng)", color: "#FF6B5B" },
...
function StageIllustration({ accent }: { accent: string }) {
  return (
    <Svg width={240} height={170} viewBox="0 0 240 170">
      ...
      <Rect x={116} y={62} width={8} height={44} rx={4} fill="#3B2A4A" />
      <Rect x={104} y={102} width={32} height={7} rx={3.5} fill="#3B2A4A" />
      ...
      <Circle cx={186} cy={20} r={2.2} fill="#FF6B5B" opacity={0.55} />
      <Circle cx={52} cy={58} r={2.4} fill="#FF6B5B" opacity={0.5} />
    </Svg>
  );
}
...
const st = StyleSheet.create({
  ...
  skip: { fontSize: 12, color: "#BFB4C4", fontFamily: F.med },
